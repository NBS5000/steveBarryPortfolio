            ...
            <div id="myModal_menu" className="modal">
                <div className="modal-content">
                    <div id = "container_menu">         
                        ...
                        <div className="modalContact">
                            <div className="contactIcon">
                                <a className="modContactLink" href="https://www.linkedin.com/in/stephen-barry-676306108/" target="_blank">
                        ...
                        <div className="modalContact">
                            <div className="contactIcon">
                                <a className="modContactLink" href="https://www.google.com/maps/place/Terrigal+NSW+2260/@-33.4457731,151.4113257,14z/data=!3m1!4b1!4m5!3m4!1s0x6b72b58677fc5889:0x5017d681632de80!8m2!3d-33.448011!4d151.444461" target="_blank">
                        ...
                        <div className="modalContact">
                            <div id="optionsCV" className="contactIcon">
                                <a id="viewCV" className="modContactLink" href="https://docs.google.com/document/d/1rUfsYP4VY3RjZRth_pvh2s8ZYj7r6FfjqfcYySy1COc/edit?usp=sharing" target="_blank">
